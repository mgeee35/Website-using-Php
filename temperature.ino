#define ag_ismi "G4_1658"       //your phone nick name
#define ag_sifresi "1111bbbb"   //your password
...
void sicaklik_yolla(float sicaklik){
 ...
 String yollanacakkomut = "GET /update?key=BG34H5P15ZEOU8EU&field1=";   // Burada 64T0OS3R1OEAYUML yazan kısım bizim API Key den aldığımız Key. Siz buraya kendi keyinizi yazacaksınız.
